...
import edu.depaul.cdm.se452.fall2023group1.books.*;
...
//        Book book1 = new Book(1L, "9739905387948", "OLqkftPAIe", "swzSaDXavM", 1925, "ZCzdQILBpi", "description1", 3, BookStatus.AVAILABLE, 3.2);
//        Book book2 = new Book(2L, "6673131741758", "ANNeEAVxDs", "elJMKUMWPX", 1906, "TgIPcDACGf", "description2", 17, BookStatus.RESERVED, 3.3);
//        Book book3 = new Book(3L, "3230651772286", "UzBZaJagoM", "ToNzkzJWop", 1952, "aLVguUaPTj", "description3", 12, BookStatus.UNAVAILABLE, 3.6);
//        Book book4 = new Book(4L, "2888594110650", "AXPEcxvRHs", "kBmdkNTFlI", 1938, "AVzoswkfIK", "description4", 5, BookStatus.UNAVAILABLE, 0.8);
//        Book book5 = new Book(5L, "4702631746185", "NpJOHezqux", "loQVoCrwjU", 1920, "cLVziRusdW", "description5", 12, BookStatus.UNAVAILABLE, 2.8);
//
